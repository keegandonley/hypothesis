...
const experiments = [
  {
    ...
    name: 'iframe-proxy',
    description:
      'Route postMessage events through an iframe boundary for testing and debugging.',
    href: '/iframe-proxy',
  },
  {
    id: 'EXP-002',
    name: 'messages',
    description:
      'Capture and inspect messages received from a parent frame in real time.',
    href: '/messages',
  },
];
    ...
    >
      <div style={{ width: '100%', maxWidth: '560px' }}>
        ...
        <header style={{ marginBottom: '48px' }}>
          ...
          >
            A toolkit for probing web platform primitives.
          </p>
        </header>
