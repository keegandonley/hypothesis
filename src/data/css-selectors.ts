...
export const CSS_SELECTOR_GROUPS: CssSelectorGroup[] = [
  {
    ...
    selectors: [
      ...
      },
      {
        ...
        example: "#header { position: sticky; }",
        specificity: "1,0,0",
      },
    ],
  },
  ...
  },
  {
    ...
    selectors: [
      {
        selector: ":hover",
        description: "Matches when the user's pointer is over the element.",
        example: "a:hover { text-decoration: underline; }",
        specificity: "+0,1,0",
      },
      {
        selector: ":focus",
        description: "Matches when the element has keyboard focus.",
      ...
      },
      {
        ...
        example: "tr:nth-child(even) { background: #f5f5f5; }",
        specificity: "+0,1,0",
      },
      {
        ...
        example: "p:nth-of-type(2) { color: gray; }",
        specificity: "+0,1,0",
      },
      {
      ...
      },
      {
        ...
        example: ":is(h1, h2, h3) { font-weight: bold; }",
      ...
      },
      {
        ...
        example: ":where(ul, ol) { padding-left: 1.5em; }",
        specificity: "0,0,0",
      },
      {
        ...
        example: "div:has(img) { display: grid; }",
        specificity: "+specificity of argument",
      },
      {
        selector: ":checked",
      ...
      {
        selector: ":disabled",
        description: "Matches form elements that are disabled.",
  ...
  },
  {
    ...
    selectors: [
      ...
      },
      {
        ...
        example: "p::first-letter { font-size: 3em; float: left; }",
        specificity: "+0,0,1",
      },
      {
        selector: "::placeholder",
        description: "Matches the placeholder text of an input or textarea.",
        example: "input::placeholder { color: #aaa; }",
        specificity: "+0,0,1",
      },
      {
        selector: "::selection",
        description: "Matches the portion of text selected by the user.",
        example: "::selection { background: #ff0; color: #000; }",
        specificity: "+0,0,0",
      },
      {
        selector: "::marker",
        ...
        example: "li::marker { color: var(--accent); }",
        specificity: "+0,0,1",
      },
    ],
  },
  {
    ...
    selectors: [
      ...
      },
      {
        ...
        example: "h1, h2, h3 { line-height: 1.2; }",
