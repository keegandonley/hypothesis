...
export const PORT_GROUPS: PortGroup[] = [
  {
    ...
    ports: [
      ...
      },
      {
        ...
        protocol: "TCP",
        service: "HTTPS",
        description: "HTTP Secure — TLS-encrypted web traffic.",
      },
      {
        port: 8080,
        protocol: "TCP",
      ...
      },
      {
        ...
        protocol: "TCP",
        service: "Angular dev",
        description: "Default port for the Angular CLI development server.",
      },
    ],
  },
  {
    ...
    ports: [
      {
        ...
        description: "MySQL and MariaDB relational database server.",
      },
      {
        port: 5432,
        protocol: "TCP",
      ...
      },
      {
        ...
        protocol: "TCP",
        service: "Oracle DB",
        description: "Oracle Database listener default port.",
      },
      {
        port: 27017,
        protocol: "TCP",
        service: "MongoDB",
        description: "MongoDB document database default port.",
      },
      {
        port: 6379,
        protocol: "TCP",
      ...
      },
      {
        ...
        protocol: "TCP",
        service: "CouchDB",
        description: "Apache CouchDB document-oriented database HTTP API.",
      },
      {
        port: 9200,
        protocol: "TCP",
      ...
      },
      {
        ...
        protocol: "TCP",
        service: "Cassandra",
        description: "Apache Cassandra native transport port.",
      },
    ],
  },
  {
    ...
    ports: [
      {
        ...
        protocol: "TCP",
        service: "FTP data",
        description: "FTP active mode data transfer channel.",
      },
      {
        port: 21,
        protocol: "TCP",
      ...
      },
      {
        ...
        protocol: "TCP/UDP",
        service: "NFS",
        description: "Network File System — Unix/Linux network file sharing.",
      },
      {
        port: 548,
        protocol: "TCP",
  ...
  },
  {
    ...
    ports: [
      ...
      },
      {
        ...
        description: "RabbitMQ web management console and HTTP API.",
      },
      {
        port: 1883,
        protocol: "TCP",
      ...
      },
      {
        port: 2376,
        protocol: "TCP",
        service: "Docker daemon (TLS)",
        description: "Docker Engine API over TLS.",
      },
    ],
  },
];
