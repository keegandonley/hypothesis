// Pure color math — no DOM, no React. Runs identically in browser and Node.
...
export type ColorFormat = "hex6" | "hex8" | "rgb" | "rgba" | "hsl" | "oklch";
...
// OKLCH pipeline — sRGB ↔ linear ↔ XYZ-D65 ↔ OKLab ↔ OKLCH
...
export function formatColor(color: RGBA, fmt: ColorFormat): string {
  switch (fmt) {
    case "hex6":
      return toHex6(color);
    case "hex8":
