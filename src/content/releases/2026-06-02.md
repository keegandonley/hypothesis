...
> **Update (2026-07-10):** The MCP server now recommends the Streamable HTTP transport at `https://hypothesis.sh/api/mcp`. The SSE command below still works but is **deprecated** — see the [current docs](/docs/mcp) for the recommended setup.
