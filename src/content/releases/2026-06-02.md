...
> **Update (2026-07-16):** The SSE endpoint below has been **retired** and now returns `410 Gone`. The MCP server uses the Streamable HTTP transport at `https://hypothesis.sh/api/mcp` — see the [current docs](/docs/mcp) for the up-to-date setup.
